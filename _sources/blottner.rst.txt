...
.. figure:: ./figures/blottner_sphere/blottner_schematic.png
  :width: 30 %
  :align: center
...
.. figure:: ./figures/blottner_sphere/fom_meshflow.png
    :scale: 50 %
...
.. figure:: ./figures/blottner_sphere/sample_mesh.png
    :scale: 30 %
...
.. figure:: ./figures/blottner_sphere/Picture2.png
    :scale: 40 %
    :alt: Blottner Sphere Mesh and steady-state solution.
