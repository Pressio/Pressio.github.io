.. This file is generated by docs/generate_health.py. Edit the JSON config instead.
...
last collected **2026-09-04 00:49 UTC**. Lifecycle assessments and next objectives
...
.. raw:: html
   ...
   <div class="health-summary" aria-label="Ecosystem summary">
     ...
     <div><strong>1</strong><span>Modernization planned</span></div>
   </div>
...
.. raw:: html
   ...
   <article class="health-card" data-status="healthy">
     ...
     <div class="health-metrics">
       <a class="health-metric" href="https://github.com/Pressio/pressio-rom/releases">
         <span>Latest release</span><strong>0.17.0</strong>
         <small>Date unavailable</small>
       </a>
       <a class="health-metric" href="https://github.com/Pressio/pressio-rom/actions">
       ...
       <a class="health-metric" href="https://github.com/Pressio/pressio-rom/issues?q=is%3Aissue+is%3Aopen">
         <span>Open issues</span><strong>—</strong>
       ...
       <a class="health-metric" href="https://github.com/Pressio/pressio-rom/issues?q=is%3Aissue+is%3Aopen+label%3Arelease-blocker">
         <span>Release blockers</span><strong>—</strong>
   ...
   <article class="health-card" data-status="healthy">
     ...
     <div class="health-metrics">
       <a class="health-metric" href="https://github.com/Pressio/pressio-ops/releases">
         <span>Latest release</span><strong>0.17.0</strong>
         <small>Date unavailable</small>
       </a>
       <a class="health-metric" href="https://github.com/Pressio/pressio-ops/actions">
         <span>Default-branch CI</span><strong class="ci-unknown">Unknown</strong>
         <small>Latest completed run</small>
       </a>
   ...
   <article class="health-card" data-status="healthy">
     ...
     <div class="health-metrics">
       <a class="health-metric" href="https://github.com/Pressio/pressio-demoapps/releases">
         <span>Latest release</span><strong>0.17.0</strong>
         <small>Date unavailable</small>
       </a>
       <a class="health-metric" href="https://github.com/Pressio/pressio-demoapps/actions">
         <span>Default-branch CI</span><strong class="ci-unknown">Unknown</strong>
         <small>Latest completed run</small>
       </a>
   ...
   <article class="health-card" data-status="modernization-planned">
     <div class="health-card__header">
       <div>
       ...
       <span class="health-status health-status--modernization-planned">Modernization planned</span>
     </div>
     <div class="health-metrics">
       <a class="health-metric" href="https://github.com/Pressio/pressio4py/releases">
         <span>Latest release</span><strong>0.12.0</strong>
         <small>Date unavailable</small>
       </a>
   ...
   <article class="health-card" data-status="healthy">
     ...
     <div class="health-metrics">
       <a class="health-metric" href="https://github.com/Pressio/rom-tools-and-workflows/releases">
         <span>Latest release</span><strong>0.2.0</strong>
         <small>Date unavailable</small>
       </a>
       <a class="health-metric" href="https://github.com/Pressio/rom-tools-and-workflows/actions">
         <span>Default-branch CI</span><strong class="ci-unknown">Unknown</strong>
         <small>Latest completed run</small>
       </a>
